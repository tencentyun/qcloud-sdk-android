...
import static com.tencent.cos.xml.crypto.KMSSecuredCEK.isKMSKeyWrapped;
...
final class ContentCryptoMaterial {
    ...
    private static SecretKey cek(byte[] cekSecured, String keyWrapAlgo,
            ...
            ContentCryptoScheme contentCryptoScheme, QCLOUDKMS kms) throws CosXmlClientException {
    ...
    static ContentCryptoMaterial fromObjectMetadata(ObjectMetadata metadata,
            ...
            boolean keyWrapExpected, QCLOUDKMS kms) throws CosXmlClientException, JSONException {
    ...
    static ContentCryptoMaterial fromObjectMetadata(ObjectMetadata metadata,
            EncryptionMaterialsAccessor kekMaterialAccessor, Provider securityProvider,
            long[] range, boolean keyWrapExpected, QCLOUDKMS kms) throws CosXmlClientException, JSONException {
        ...
        if (isRangeGet) {
            ...
            if (tagLenExpected > 0) {
                ...
                if (tagLenExpected != tagLenActual) {
                    throw CosXmlClientException.internalException("Unsupported tag length: " + tagLenActual
    ...
    ContentCryptoMaterial recreate(Map<String, String> newKEKMatDesc,
            ...
            QCLOUDKMS kms, CosXmlRequest req) throws CosXmlClientException {
        ...
        if (newKEK == null) {
            throw CosXmlClientException.internalException("No material available with the description "
    ...
    ContentCryptoMaterial recreate(EncryptionMaterials newKEK, EncryptionMaterialsAccessor accessor,
            COSCryptoScheme targetScheme, Provider p, QCLOUDKMS kms, CosXmlRequest req) throws CosXmlClientException {
    ...
    static ContentCryptoMaterial create(SecretKey cek, byte[] iv, EncryptionMaterials kekMaterials,
            ...
            Provider provider, QCLOUDKMS kms, CosXmlRequest req) throws CosXmlClientException {
     ...
     */
    static ContentCryptoMaterial create(SecretKey cek, byte[] iv, EncryptionMaterials kekMaterials,
            COSCryptoScheme scheme, Provider provider, QCLOUDKMS kms, CosXmlRequest req) throws CosXmlClientException {
    ...
    public static ContentCryptoMaterial wrap(SecretKey cek, byte[] iv,
            ContentCryptoScheme contentCryptoScheme, Provider provider, SecuredCEK cekSecured) throws CosXmlClientException {
