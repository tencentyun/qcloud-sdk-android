...
public class Task<TResult> {
   ...
   */
  public static final ExecutorService BACKGROUND_EXECUTOR = com.tencent.bolts.BoltsExecutors.background();
   ...
   */
  private static final Executor IMMEDIATE_EXECUTOR = com.tencent.bolts.BoltsExecutors.immediate();

  /**
   * An {@link Executor} that executes tasks on the UI thread.
   */
  public static final Executor UI_THREAD_EXECUTOR = com.tencent.bolts.AndroidExecutors.uiThread();
  ...
  private com.tencent.bolts.UnobservedErrorNotifier unobservedErrorNotifier;
  private List<com.tencent.bolts.Continuation<TResult, Void>> continuations = new ArrayList<>();
  ...
  /**
   * @deprecated Please use {@link com.tencent.bolts.TaskCompletionSource ()} instead.
   */
  ...
  public static <TResult> Task<TResult> forResult(TResult value) {
    ...
    com.tencent.bolts.TaskCompletionSource<TResult> tcs = new com.tencent.bolts.TaskCompletionSource<>();
    tcs.setResult(value);
    return tcs.getTask();
  }
  ...
  public static Task<Void> delay(long delay) {
    return delay(delay, com.tencent.bolts.BoltsExecutors.scheduled(), null);
  }
   ...
   */
  public static Task<Void> delay(long delay, com.tencent.bolts.CancellationToken cancellationToken) {
    return delay(delay, com.tencent.bolts.BoltsExecutors.scheduled(), cancellationToken);
  }

  /* package */ static Task<Void> delay(long delay, ScheduledExecutorService executor, final com.tencent.bolts.CancellationToken cancellationToken) {
    ...
    final com.tencent.bolts.TaskCompletionSource<Void> tcs = new com.tencent.bolts.TaskCompletionSource<>();
  ...
  public Task<Void> makeVoid() {
    return this.continueWithTask(new com.tencent.bolts.Continuation<TResult, Task<Void>>() {
      @Override
   ...
   * Invokes the callable on a background thread, returning a Task to represent the operation.
   */
  public static <TResult> Task<TResult> callInBackground(Callable<TResult> callable, com.tencent.bolts.CancellationToken ct) {
   ...
   */
  public static <TResult> Task<TResult> call(final Callable<TResult> callable, Executor executor,
      final com.tencent.bolts.CancellationToken ct) {
    final com.tencent.bolts.TaskCompletionSource<TResult> tcs = new com.tencent.bolts.TaskCompletionSource<>();
    try {
      ...
      tcs.setError(new com.tencent.bolts.ExecutorException(e));
    }
   ...
   * Invokes the callable on the current thread, producing a Task.
   */
  public static <TResult> Task<TResult> call(final Callable<TResult> callable, com.tencent.bolts.CancellationToken ct) {
  ...
  public static <TResult> Task<Task<TResult>> whenAnyResult(Collection<? extends Task<TResult>> tasks) {
    ...
    final com.tencent.bolts.TaskCompletionSource<Task<TResult>> firstCompleted = new com.tencent.bolts.TaskCompletionSource<>();
    final AtomicBoolean isAnyTaskComplete = new AtomicBoolean(false);

    for (Task<TResult> task : tasks) {
      task.continueWith(new com.tencent.bolts.Continuation<TResult, Void>() {
        @Override
  ...
  public static Task<Task<?>> whenAny(Collection<? extends Task<?>> tasks) {
    ...
    final com.tencent.bolts.TaskCompletionSource<Task<?>> firstCompleted = new com.tencent.bolts.TaskCompletionSource<>();
    final AtomicBoolean isAnyTaskComplete = new AtomicBoolean(false);

    for (Task<?> task : tasks) {
      ((Task<Object>) task).continueWith(new com.tencent.bolts.Continuation<Object, Void>() {
        @Override
   ...
   * single task fails or an {@link com.tencent.bolts.AggregateException} of all the {@link Exception}s
  ...
  public static <TResult> Task<List<TResult>> whenAllResult(final Collection<? extends Task<TResult>> tasks) {
    return whenAll(tasks).onSuccess(new com.tencent.bolts.Continuation<Void, List<TResult>>() {
      @Override
  ...
  public static Task<Void> whenAll(Collection<? extends Task<?>> tasks) {
    ...
    final com.tencent.bolts.TaskCompletionSource<Void> allFinished = new com.tencent.bolts.TaskCompletionSource<>();
    ...
    for (Task<?> task : tasks) {
      ...
      t.continueWith(new com.tencent.bolts.Continuation<Object, Void>() {
        @Override
        public Void then(Task<Object> task) {
          if (task.isFaulted()) {
  ...
  public Task<Void> continueWhile(Callable<Boolean> predicate,
      com.tencent.bolts.Continuation<Void, Task<Void>> continuation) {
   ...
   */
  public Task<Void> continueWhile(Callable<Boolean> predicate,
                                  com.tencent.bolts.Continuation<Void, Task<Void>> continuation, com.tencent.bolts.CancellationToken ct) {
  ...
  public Task<Void> continueWhile(final Callable<Boolean> predicate,
                                  final com.tencent.bolts.Continuation<Void, Task<Void>> continuation, final Executor executor) {
  ...
  public Task<Void> continueWhile(final Callable<Boolean> predicate,
                                  final com.tencent.bolts.Continuation<Void, Task<Void>> continuation, final Executor executor,
                                  final com.tencent.bolts.CancellationToken ct) {
    final com.tencent.bolts.Capture<com.tencent.bolts.Continuation<Void, Task<Void>>> predicateContinuation =
        new Capture<>();
    predicateContinuation.set(new com.tencent.bolts.Continuation<Void, Task<Void>>() {
      @Override
  ...
  public <TContinuationResult> Task<TContinuationResult> continueWith(
          final com.tencent.bolts.Continuation<TResult, TContinuationResult> continuation, final Executor executor) {
  ...
  public <TContinuationResult> Task<TContinuationResult> continueWith(
          ...
          final com.tencent.bolts.CancellationToken ct) {
    boolean completed;
    final com.tencent.bolts.TaskCompletionSource<TContinuationResult> tcs = new com.tencent.bolts.TaskCompletionSource<>();
    synchronized (lock) {
      completed = this.isCompleted();
      if (!completed) {
        this.continuations.add(new com.tencent.bolts.Continuation<TResult, Void>() {
          @Override
          public Void then(Task<TResult> task) {
   ...
   */
  public <TContinuationResult> Task<TContinuationResult> continueWith(
      com.tencent.bolts.Continuation<TResult, TContinuationResult> continuation) {
   ...
   */
  public <TContinuationResult> Task<TContinuationResult> continueWith(
          com.tencent.bolts.Continuation<TResult, TContinuationResult> continuation, com.tencent.bolts.CancellationToken ct) {
  ...
  public <TContinuationResult> Task<TContinuationResult> continueWithTask(
          final com.tencent.bolts.Continuation<TResult, Task<TContinuationResult>> continuation, final Executor executor) {
   ...
   */
  public <TContinuationResult> Task<TContinuationResult> continueWithTask(
      com.tencent.bolts.Continuation<TResult, Task<TContinuationResult>> continuation) {
   ...
   */
  public <TContinuationResult> Task<TContinuationResult> continueWithTask(
          com.tencent.bolts.Continuation<TResult, Task<TContinuationResult>> continuation, com.tencent.bolts.CancellationToken ct) {
  ...
  public <TContinuationResult> Task<TContinuationResult> onSuccess(
          final com.tencent.bolts.Continuation<TResult, TContinuationResult> continuation, Executor executor) {
  ...
  public <TContinuationResult> Task<TContinuationResult> onSuccess(
          final com.tencent.bolts.Continuation<TResult, TContinuationResult> continuation, Executor executor,
          final com.tencent.bolts.CancellationToken ct) {
    return continueWithTask(new com.tencent.bolts.Continuation<TResult, Task<TContinuationResult>>() {
      @Override
   ...
   */
  public <TContinuationResult> Task<TContinuationResult> onSuccess(
      final com.tencent.bolts.Continuation<TResult, TContinuationResult> continuation) {
   ...
   */
  public <TContinuationResult> Task<TContinuationResult> onSuccess(
          final com.tencent.bolts.Continuation<TResult, TContinuationResult> continuation, com.tencent.bolts.CancellationToken ct) {
  ...
  public <TContinuationResult> Task<TContinuationResult> onSuccessTask(
          final com.tencent.bolts.Continuation<TResult, Task<TContinuationResult>> continuation, Executor executor) {
   ...
   */
  public <TContinuationResult> Task<TContinuationResult> onSuccessTask(
      final com.tencent.bolts.Continuation<TResult, Task<TContinuationResult>> continuation) {
  ...
  public <TContinuationResult> Task<TContinuationResult> onSuccessTask(
      final com.tencent.bolts.Continuation<TResult, Task<TContinuationResult>> continuation,
      com.tencent.bolts.CancellationToken ct) {
  ...
  private static <TContinuationResult, TResult> void completeImmediately(
          final com.tencent.bolts.TaskCompletionSource<TContinuationResult> tcs,
          final com.tencent.bolts.Continuation<TResult, TContinuationResult> continuation, final Task<TResult> task,
          Executor executor, final com.tencent.bolts.CancellationToken ct) {
    try {
      executor.execute(new Runnable() {
        @Override
        public void run() {
        ...
        public void run() {
          ...
          try {
            ...
            if (result == null) {
              ...
              result.continueWith(new com.tencent.bolts.Continuation<TContinuationResult, Void>() {
                @Override
  ...
  /* package */ boolean trySetError(Exception error) {
    synchronized (lock) {
      ...
      if (!errorHasBeenObserved && getUnobservedExceptionHandler() != null)
        unobservedErrorNotifier = new com.tencent.bolts.UnobservedErrorNotifier(this);
      return true;
    }
  }
   ...
   * @deprecated Please use {@link com.tencent.bolts.TaskCompletionSource} instead.
   */
  public class TaskCompletionSource extends com.tencent.bolts.TaskCompletionSource<TResult> {
