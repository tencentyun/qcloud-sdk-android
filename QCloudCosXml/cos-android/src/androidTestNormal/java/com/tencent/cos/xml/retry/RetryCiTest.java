...
//    private static final String CI_HOST_TENCENTCI = "cos-sdk-citest-1253960454.ci.ap-beijing.tencentci.cn";
    ...
    @Before
    public void init() {
        ciServiceMyqcloud = NormalServiceFactory.INSTANCE.newRetryCIServiceMyqcloud(true);
        ciServiceMyqcloudNoSwitch = NormalServiceFactory.INSTANCE.newRetryCIServiceMyqcloud(false);
        ciServiceTencentCI = NormalServiceFactory.INSTANCE.newRetryCIServiceTencentCI(true);
        ciServiceTencentCINoSwitch = NormalServiceFactory.INSTANCE.newRetryCIServiceTencentCI(false);
    }
