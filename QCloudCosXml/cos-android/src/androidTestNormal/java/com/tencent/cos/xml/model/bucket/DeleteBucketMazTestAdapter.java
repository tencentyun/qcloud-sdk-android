...
// Generate by auto
public class DeleteBucketMazTestAdapter extends NormalRequestTestAdapter<DeleteBucketRequest, DeleteBucketResult> {
    @Override
    protected DeleteBucketRequest newRequestInstance() {
        DeleteBucketRequest request = new DeleteBucketRequest(TestConst.TEMP_BUCKET_MAZ);
