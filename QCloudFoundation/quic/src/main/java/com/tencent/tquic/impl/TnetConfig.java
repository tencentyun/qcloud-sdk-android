...
public class TnetConfig {
    ...
    private TnetConfig(Builder builder) {
        ...
        this.mIsCustom = builder.mIsCustom;
        this.mSupportV6 = builder.mSupportV6;
    }
    ...
    public static class Builder {
        ...
        public Builder(TnetConfig tnetConfig) {
            ...
            this.mIsCustom = tnetConfig.mIsCustom;
            this.mSupportV6 = tnetConfig.mSupportV6;
        }
        ...
        /**
         * 设置拥塞协议
         * @param congestionType 默认为2 kBBR
         *   0 kCubicBytes,
         *   1 kRenoBytes,
         *   2 kBBR,
         *   3 kPCC,
        ...
        public Builder setSupportV6(boolean supportV6) {
            this.mSupportV6 = supportV6;
            return this;
        }
